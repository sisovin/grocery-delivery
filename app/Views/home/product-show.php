...
$imagePath = $imageMap[$product->id] ?? 'assets/images/01-popular-product.png';
?>
<article class="max-w-3xl mx-auto bg-white rounded-3xl border border-emerald-100 p-8">
  ...
  <img class="w-full h-72 object-cover rounded-2xl border border-emerald-100 mb-5" src="<?= e(asset($imagePath)) ?>"
    alt="<?= e($product->name) ?>">
