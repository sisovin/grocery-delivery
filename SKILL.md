---
name: fullstack-uiux-php-pro
description: |
  Consolidated full-stack skill that combines UI/UX design intelligence and native
  PHP 8.5 engineering for this repository. Use for planning, building, reviewing,
  refactoring, and debugging web products end-to-end: visual design, interaction,
  accessibility, frontend implementation, backend architecture, PDO + MySQL,
  authentication, authorization, security hardening, and deployment-aware decisions.
  This skill is data-backed by CSV knowledge bases in data/, implemented via
  Python tools in scripts/, and grounded by practical references in references/.
license: MIT
---
